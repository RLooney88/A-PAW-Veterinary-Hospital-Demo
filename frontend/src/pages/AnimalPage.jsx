...
const ANIMALS = {
  dogs: {
    ...
    life_stages: [
      ...
      { name: "Adult", age: "1 – 7 yrs", focus: "Annual wellness, dental care, parasite prevention, weight management, lifestyle vaccines.", icon: "shield", image: "/images/animals/dog-adult.webp", objectPosition: "object-top" },
    ...
    conditions: [
      ...
      { name: "Arthritis & joint pain", body: "Stiffness getting up, reluctance on stairs, slowing on walks.", image: "/images/animals/dog-arthritis.webp", objectPosition: "object-top" },
  ...
  cats: {
    ...
    life_stages: [
      ...
      { name: "Adult", age: "1 – 10 yrs", focus: "Annual wellness exam, dental screening, parasite prevention, weight and behavior check-ins.", icon: "shield", image: "/images/animals/cat-adult.webp", objectPosition: "object-top" },
  ...
  critters: {
    ...
    life_stages: [
      ...
      { name: "Adult", age: "Prime years", focus: "Annual wellness, weight and dental check, enrichment and habitat review.", icon: "shield", image: "/images/animals/rabbit-adult.webp", objectPosition: "object-top" },
